...
const PROJECTS = [
  {
    id:"scentopia", cover:"assets/proj-scentopia.png", wide:true, year:"2024",
    title:{en:"Scentopia",zh:"Scentopia 嗅觉界面"},
    tags:{en:"Olfactory · Wearable · AR",zh:"嗅觉 · 可穿戴 · AR"},
    subtitle:{en:"Bringing smell into spatial computing — an olfactory necklace for the age of AR.",
              zh:"把“气味”带入空间计算 —— 面向 AR 时代的嗅觉项链。"},
    role:{en:"Concept · Industrial Design · Interaction",zh:"概念 · 工业设计 · 交互"},
    type:{en:"Olfactory Wearable",zh:"嗅觉可穿戴"},
    tools:"Rhino · Keyshot · Arduino · CMF",
    body:[
      {en:"Scentopia explores scent as a digital medium — an olfactory necklace that pairs with spatial computing devices to add smell to augmented experiences.",
       zh:"Scentopia 把气味视为一种数字媒介 —— 一款与空间计算设备配对的嗅觉项链,为增强现实体验补上“嗅觉”这一维度。"},
      {en:"Building on my published research into olfactory information design, the project asks how a wearable could release, blend and time scent as naturally as a screen shows light.",
       zh:"延续我在嗅觉信息设计方向的已发表研究,项目探讨可穿戴设备能否像屏幕呈现光线那样,自然地释放、调和并精准控制气味。"},
    ],
    gallery:["assets/proj-scentopia.png","assets/scentopia-2.png","assets/scentopia-4.png","assets/scentopia-3.png"],
  },
  {
